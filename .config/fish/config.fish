...
set -U fish_user_paths $HOME/.local/bin /usr/bin /usr/local/bin $HOME/.cargo/bin $HOME/.config/emacs/bin /usr/bin/site_perl /usr/bin/vendor_perl /usr/bin/core_perl $fish_user_paths
